...
export const Track = (props) => {
    ...
    return (
        <>
            <div className=" bg-gradient-to-b from-cyan-500 to-blue-500  pt-14">
                <h2 className="max-w-lg font-sans text-4xl mx-auto text-center leading-none tracking-tight text-gray-900 sm:text-5xl md:mx-auto">
                    {language === "En"
                        ? "Track your workouts"
                        : "Notez vos entraînements."}
                </h2>

                <div className="container mx-auto px-16 pb-8 max-w-4xl  min-h-[50vh] ">
                    <div className="flex flex-row justify-around mb-16 mt-10  max-w-[38rem] mx-auto">
                        <div className="flex-1  justify-center flex-column">
